...
[Censoring and truncation](background/lifetime_modeling/censoring_and_truncation.md) for what
those mean.
...
[non-parametric lifetime models](background/lifetime_modeling/non_parametric_models.md).
...
[lifetime modeling](background/lifetime_modeling/index.md) guide.
...
[Regressions: adding covariates](background/lifetime_modeling/regressions.md).
